...
public class DBAdapter { private static final String DB_NAME = "user.db";
    ...
    public long insert(Student student) {
        ...
        newValues.put(KEY_Isused, student.getIsused());
    ...
    private Student[] ConvertToPeople(Cursor cursor){
        ...
        for (int i = 0 ; i<resultCounts; i++){
            ...
            peoples[i].setIsused(cursor.getString(cursor.getColumnIndex(KEY_Isused)));
    ...
    private static class DBOpenHelper extends SQLiteOpenHelper {
        ...
        private static final String DB_CREATE = "create table " +
                ...
                " text not null, "+KEY_Isused+" text not null );";
